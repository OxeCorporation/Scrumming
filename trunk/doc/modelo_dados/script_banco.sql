...
-- Usuario teste que não é a Empresa, é um funcionario da empresa.
INSERT INTO `scrumming`.`usuario`
(`nome`,
`email`,
`login`,
...
insert 
    ...
    values
        (now(), NULL, now(), now(), null, 'Descrição da sprint 01', 'Sprint01', 1, 1);
...
insert 
    into
        ...
        (data_cadastro, data_fechamento, data_fim, data_inicio, data_revisao, descricao, nome, FK_projeto, situacao_sprint) 
    values
        (now(), NULL, now(), now(), null, 'Descrição da sprint 02', 'Sprint02', 1, 1);
...
insert 
    into
        ...
        (data_cadastro, data_fechamento, data_fim, data_inicio, data_revisao, descricao, nome, FK_projeto, situacao_sprint) 
    values
        (now(), NULL, now(), now(), null, 'Descrição da sprint 03', 'Sprint03', 1, 1);
...
-- *******************************************************************************
--                               FIM DO SCRIPT
>>>>>>> 44200344f05632858665a98cc01d21ce18a91723
-- *******************************************************************************