...
public class TarefaAdapter extends ArrayAdapter<Tarefa> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.txtSituacaoTarefa = (TextView) convertView.findViewById(R.id.txtSituacaoTarefa);
			holder.txtTempoEstimadoTarefa = (TextView) convertView.findViewById(R.id.txtTempoEstimadoTarefa);
		...
		holder.txtSituacaoTarefa.setText(tarefa.getSituacaoDescricao());
		holder.txtTempoEstimadoTarefa.setText(tarefa.getTempoEstimado());
	...
	static class ViewHolder {
		...
		TextView txtSituacaoTarefa;
		TextView txtTempoEstimadoTarefa;
	}
}