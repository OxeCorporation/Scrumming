...
public class SprintFragment extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View layout = inflater.inflate(R.layout.fragment_sprint, container,
				false);

		progressSprint = (ProgressBar) layout
				.findViewById(R.id.progressBarSprint);
		txtMensagemSprint = (TextView) layout
				.findViewById(R.id.txtMensagemSprint);

		// pega o projeto clicado no projetoFragment para listar as sprints
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (getActivity() instanceof ClickedOnSprint) {
			((ClickedOnSprint) getActivity()).sprintFoiClicada(
					listaSprints.get(position), usuarioEmpresa);
		}
	}
